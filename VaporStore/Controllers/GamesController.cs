...
namespace VaporStore.Controllers
{
    public class GamesController : Controller
    {
        ...
        public GamesController(VaporStoreContext context)
        {
            _context = context;
        }
        ...
        {
            var vaporStoreContext = _context.Games.Include(g => g.Developer).Include(g => g.Genre);
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Price,ReleaseDate,DeveloperId,GenreId")] Game game)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Price,ReleaseDate,DeveloperId,GenreId")] Game game)
        {
            if (id != game.Id)
            {
                return NotFound();
